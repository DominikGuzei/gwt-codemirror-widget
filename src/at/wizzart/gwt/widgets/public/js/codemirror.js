 ...
 *
 *	This is the original code mirror source file
 *	which is required to be added on the host page.
 *	Fixed some minor bugs that occured during development.
 *	if you want to know what i fixed specifically please
 *	compare this with the codemirror_original.js version.
 */
  ...
  CodeMirror.prototype = {
    ...
    setLineNumbers: function(on) {
      if (on && !this.lineNumbers) {
        ...
        console.log("setLineNumber on: "+this.lineNumbers);
    ...
    activateLineNumbers: function() {
      if(this.lineNumbers) {
	      ...
	      nums = this.lineNumbers, scroller = nums.firstChild;
